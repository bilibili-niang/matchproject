...
function popInit() {
    const chartDom = document.getElementById('pop');
    const myChart = echarts.init(chartDom);

    let xLabel = ['柳州', '杭州', '天津', '威海', '丽江', '珠江', '淄博'];
    let dataValue = [193, 269, 336, 468, 595, 652, 723];
    let option = {
        title: {
            text: '近期游客量剧增城市',
            textStyle: {
...
function lineInit() {
    ...
    const option = {
        baseOption: {
            ...
            legend: {
                left: 'right',
                data: ['海边度假', '名山名水', '历史人文', 'GDP', '金融', '房地产'],
                selected: {
                    GDP: true,
                    金融: true,
                    房地产: true
        ...
        options: [
            {
                ...
                series: [
                    ...
                    {
                        data: [
                            {name: '海边度假', value: dataMap.dataPI['2002sum']},
                            {name: '名山名水', value: dataMap.dataSI['2002sum']},
                            {name: '历史人文', value: dataMap.dataTI['2002sum']}
                        ]
                    }
                ]
            },
            {
                title: {text: '2014全国宏观旅游额总量'},
                series: [
                    ...
                    {
                        data: [
                            {name: '海边度假', value: dataMap.dataPI['2003sum']},
                            {name: '名山名水', value: dataMap.dataSI['2003sum']},
                            {name: '历史人文', value: dataMap.dataTI['2003sum']}
                        ]
                    }
                ]
            },
            {
                title: {text: '2015全国宏观旅游额总量'},
                series: [
                    ...
                    {
                        data: [
                            {name: '海边度假', value: dataMap.dataPI['2004sum']},
                            {name: '名山名水', value: dataMap.dataSI['2004sum']},
                            {name: '历史人文', value: dataMap.dataTI['2004sum']}
                        ]
                    }
                ]
            },
            {
                title: {text: '2016全国宏观旅游额总量'},
                series: [
                    ...
                    {
                        data: [
                            {name: '海边度假', value: dataMap.dataPI['2005sum']},
                            {name: '名山名水', value: dataMap.dataSI['2005sum']},
                            {name: '历史人文', value: dataMap.dataTI['2005sum']}
                        ]
                    }
                ]
            },
            {
                title: {text: '2017全国宏观旅游额总量'},
                series: [
                    ...
                    {
                        data: [
                            {name: '海边度假', value: dataMap.dataPI['2006sum']},
                            {name: '名山名水', value: dataMap.dataSI['2006sum']},
                            {name: '历史人文', value: dataMap.dataTI['2006sum']}
                        ]
                    }
                ]
            },
            {
                title: {text: '2018全国宏观旅游额总量'},
                series: [
                    ...
                    {
                        data: [
                            {name: '海边度假', value: dataMap.dataPI['2007sum']},
                            {name: '名山名水', value: dataMap.dataSI['2007sum']},
                            {name: '历史人文', value: dataMap.dataTI['2007sum']}
                        ]
                    }
                ]
            },
            {
                title: {text: '2019全国宏观旅游额总量'},
                series: [
                    ...
                    {
                        data: [
                            {name: '海边度假', value: dataMap.dataPI['2008sum']},
                            {name: '名山名水', value: dataMap.dataSI['2008sum']},
                            {name: '历史人文', value: dataMap.dataTI['2008sum']}
                        ]
                    }
                ]
            },
            {
                title: {text: '2020全国宏观旅游额总量'},
                series: [
                    ...
                    {
                        data: [
                            {name: '海边度假', value: dataMap.dataPI['2009sum']},
                            {name: '名山名水', value: dataMap.dataSI['2009sum']},
                            {name: '历史人文', value: dataMap.dataTI['2009sum']}
                        ]
                    }
                ]
            },
            {
                title: {text: '2021全国宏观旅游额总量'},
                series: [
                    ...
                    {
                        data: [
                            {name: '海边度假', value: dataMap.dataPI['2010sum']},
                            {name: '名山名水', value: dataMap.dataSI['2010sum']},
                            {name: '历史人文', value: dataMap.dataTI['2010sum']}
                        ]
                    }
                ]
            },
            {
                title: {text: '2022全国宏观旅游额总量'},
                series: [
                    ...
                    {
                        data: [
                            {name: '海边度假', value: dataMap.dataPI['2011sum']},
                            {name: '名山名水', value: dataMap.dataSI['2011sum']},
                            {name: '历史人文', value: dataMap.dataTI['2011sum']}
                        ]
                    }
                ]
            }
